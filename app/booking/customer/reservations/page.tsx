...
import { getMyReservations } from "../../../../store/booking/bookingThunks";
      ...
      {loading && reservations.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {reservations.map((reservation, index) => {
            ...
            const depositGhs = reservation.intended_spend_pesewas / 100;
            const creditGhs = reservation.spend_credit_remaining_pesewas / 100;
            ...
            return (
              ...
              >
                ...
                {/* Date & deposit row */}
                <div className="grid grid-cols-2 gap-5 mb-8 z-10 border-b border-gold-muted/20 pb-6">
                  ...
                  <div className="flex items-start gap-2">
                    <Banknote className="w-4 h-4 text-gold-light/60 mt-0.5" />
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gold-light/50 mb-1">
                        Initial Deposit
                      </p>
                      <p className="text-sm font-medium text-on-primary">
                        GHS {depositGhs.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-auto z-10 bg-navy-deep/50 p-5 rounded-lg border border-gold-muted/10 flex justify-between items-center backdrop-blur-md">
                  <div>
                    ...
                    <p className="text-2xl font-bold gold-gradient-text chiseled-text tracking-tight">
                      GHS {creditGhs.toFixed(2)}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      onClick={() => router.push(`/review?venue=${reservation.venue_type || 'skybar'}&non_member_reservation=${reservation.id}`)}
                    >
